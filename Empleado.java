...
public class Empleado extends Persona{
    ...
    public Empleado(String codigo, int id_puesto, int id, String nombres, String apellidos, String direccion, String telefono, String fehca_naciemiento) {
        super(id, nombres, apellidos, direccion, telefono, fehca_naciemiento);
        this.codigo = codigo;
    ...
    try{
        ...
        parametro.setString(6, getFehca_naciemiento());
